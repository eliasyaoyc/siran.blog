...
<img src="/images/raft/leader选举过程2.png" width="800" height="400">
...
<img src="/images/raft/leader选举过程1.png" width="800" height="400">
* 心跳

当有节点成为 Leader 后，定时发送心跳来维持自己的权威
1. 通过AppendEntries RPC(日志条目为null) 作为心跳。
2. 如果Follower 在一段时间内，没有接受到任何消息，也就是选举超时，那么它就会认为系统中没有可用的 Leader， 并发起选举以选出新的Leader
...
如下图所示：
<img src="/images/raft/raft实现概览.png" width="600" height="400">

* 日志的组成
1. 有序序号标记的条目组成
2. 每个条目都包含创建时的任期号（图中框中的数字）
3. 状态机需要执行的指令
<img src="/images/raft/日志复制1.png" width="600" height="400">
...
<img src="/images/raft/日志复制2.png" width="600" height="400">
...
<img src="/images/raft/日志复制错误情况.png" width="600" height="400">
...
<img src="/images/raft/配置变更1.png" width="600" height="400">
...
<img src="/images/raft/配置变更2.png" width="600" height="400">
* 第一阶段：
...
<img src="/images/raft/日志压缩.png" width="600" height="400">
